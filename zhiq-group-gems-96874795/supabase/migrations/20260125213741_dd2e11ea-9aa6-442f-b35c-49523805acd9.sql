-- Create trigger function to calculate commission on delivery acceptance
CREATE OR REPLACE FUNCTION public.calculate_commission_on_acceptance()
RETURNS trigger
LANGUAGE plpgsql
SECURITY DEFINER
...
-- Create trigger that fires BEFORE UPDATE to modify NEW values
