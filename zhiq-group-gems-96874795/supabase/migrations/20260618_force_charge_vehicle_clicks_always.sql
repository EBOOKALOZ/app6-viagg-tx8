-- Remove qualquer regra de deduplicação, limitador de cliques ou validação de dono
-- para que CADA visita e CADA clique em interesse desconte os créditos imediatamente.

-- 1) Atualiza a cobrança de VISITA (navegação)
...
begin
  ...
  -- Sem bloqueio de dono. Sem bloqueio de limite diário ou de minutos.
...
-- 2) Atualiza a cobrança de INTERESSE (botão enviar interesse)
