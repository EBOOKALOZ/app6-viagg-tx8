-- Adiciona o branch 'travel' à RPC register_contact_intention.
...
BEGIN
  ...
  INSERT INTO public.advertiser_contact_intentions (
    ...
    visitor_name, visitor_phone, visitor_message, city, region, status, created_at
  )
  VALUES (
    v_advertiser_user_id, p_listing_module, p_listing_id, p_interest_type,
    trim(p_visitor_name), regexp_replace(p_visitor_phone, '\D', '', 'g'),
    p_visitor_message, p_city, p_region, 'pending_unlock', now()
  )
