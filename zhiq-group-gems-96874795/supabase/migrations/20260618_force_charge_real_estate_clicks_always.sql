-- Remove a regra de dedup (60min) e o bloqueio do dono na cobrança de clique de
-- imóveis, igualando ao comportamento já aplicado em veículos: CADA visita
-- desconta os créditos, sem exceção.
...
begin
  ...
  -- Sem bloqueio de dono. Sem limite de 60min (igual veículos).
