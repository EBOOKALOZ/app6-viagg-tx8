-- ═══════════════════════════════════════════════════════════
-- MULTI-STORE SUBMIT — Funções para cesta multi-loja
-- Adiciona as RPCs get_global_cart_data e submit_multi_store_intention
-- ═══════════════════════════════════════════════════════════

-- ═══ 1. get_global_cart_data ═══
-- Recupera dados da cesta agrupados por loja (JSONB)
...
-- Cria intenções de compra para múltiplas lojas em uma transação
