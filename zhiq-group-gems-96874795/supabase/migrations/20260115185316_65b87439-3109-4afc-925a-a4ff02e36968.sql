-- Primeiro remover a função existente, depois recriar com novo retorno
DROP FUNCTION IF EXISTS public.get_delivery_motoboy_info(uuid);

CREATE FUNCTION public.get_delivery_motoboy_info(_delivery_id uuid)
RETURNS TABLE(
  motoboy_name text,
  motoboy_phone text,
