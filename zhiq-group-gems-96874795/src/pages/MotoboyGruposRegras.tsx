...
const sections = [
  {
    ...
    items: [
      'Cada motoboy pode vincular até 3 grupos ativos.',
  ...
  },
  {
    ...
    items: [
      '0 grupos válidos → comissão de 25% (máxima).',
      '1 grupo válido → comissão de 18%.',
      '2 grupos válidos → comissão de 11%.',
      '3 grupos válidos → comissão de 6% (mínima).',
