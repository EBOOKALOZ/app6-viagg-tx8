              ...
              <div className="pt-4 border-t border-zinc-100 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="(47) 99999-9999" inputMode="tel" maxLength={15} className={INPUT_CLS} value={contactData.whatsapp_e164} onChange={(e) => setContactData(prev => ({ ...prev, whatsapp_e164: formatBrazilianPhone(e.target.value) }))} />
                  </div>
                  <div className="space-y-2">
                    <InputLabel>Telefone (opcional)</InputLabel>
                    <Input placeholder="(47) 99999-9999" inputMode="tel" maxLength={15} className={INPUT_CLS} value={contactData.phone_e164} onChange={(e) => setContactData(prev => ({ ...prev, phone_e164: formatBrazilianPhone(e.target.value) }))} />
                  </div>
                </div>
                <div className="space-y-2">
