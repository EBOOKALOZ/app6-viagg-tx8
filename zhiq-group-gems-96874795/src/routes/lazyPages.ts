...
export const AdminOrionMarketplace = lazy(() => import("@/pages/admin/AdminOrionMarketplace"));
export const AdminOrionPersonalization = lazy(() => import("@/pages/admin/AdminOrionPersonalization"));
export const AdminOrionTrust = lazy(() => import("@/pages/admin/AdminOrionTrust"));
export const AdminOrionAutomation = lazy(() => import("@/pages/admin/AdminOrionAutomation"));
export const AdminOrionBusinessIntelligence = lazy(() => import("@/pages/admin/AdminOrionBusinessIntelligence"));
export const AdminOrionMarketing = lazy(() => import("@/pages/admin/AdminOrionMarketing"));
export const AdminOrionSecurity = lazy(() => import("@/pages/admin/AdminOrionSecurity"));
export const AdminOrionCyberDefense = lazy(() => import("@/pages/admin/AdminOrionCyberDefense"));
export const AdminOrionDataShield = lazy(() => import("@/pages/admin/AdminOrionDataShield"));
export const AdminOrionSecurityAudit = lazy(() => import("@/pages/admin/AdminOrionSecurityAudit"));
export const AdminOrionIncidentResponse = lazy(() => import("@/pages/admin/AdminOrionIncidentResponse"));
export const AdminOrionCompliance = lazy(() => import("@/pages/admin/AdminOrionCompliance"));
export const AdminOrionCertification = lazy(() => import("@/pages/admin/AdminOrionCertification"));
export const AdminOrionSales = lazy(() => import("@/pages/admin/AdminOrionSales"));
export const AdminOrionCustomerSuccess = lazy(() => import("@/pages/admin/AdminOrionCustomerSuccess"));
export const AdminOrionLogistics = lazy(() => import("@/pages/admin/AdminOrionLogistics"));
export const AdminOrionSustainability = lazy(() => import("@/pages/admin/AdminOrionSustainability"));
export const AdminOrionInnovation = lazy(() => import("@/pages/admin/AdminOrionInnovation"));
export const AdminOrionExecutive = lazy(() => import("@/pages/admin/AdminOrionExecutive"));
export const AdminOrionSearchDiscovery = lazy(() => import("@/pages/admin/AdminOrionSearchDiscovery"));
export const AdminOrionGeo = lazy(() => import("@/pages/admin/AdminOrionGeo"));
export const AdminOrionKnowledgeGraph = lazy(() => import("@/pages/admin/AdminOrionKnowledgeGraph"));
export const AdminOrionRecommendations = lazy(() => import("@/pages/admin/AdminOrionRecommendations"));
...
export const AdminOrionAuctionIntelligence = lazy(() => import("@/pages/admin/AdminOrionAuctionIntelligence"));
export const AdminOrionKnowledgeLearning = lazy(() => import("@/pages/admin/AdminOrionKnowledgeLearning"));
...
export const AdminOrionIam = lazy(() => import("@/pages/admin/AdminOrionIam"));
...
export const AdminOrionAuctionGrowth = lazy(() => import("@/pages/admin/AdminOrionAuctionGrowth"));
